### TS & Latest Version of "ErikliPizza/QuasarHybridAuth"
...
## Shortcut - Core Files
If you want to jump-in quickly, here are the core files that you may want to check in.

You can delete all other files such as formkit implementation, example CRUDs ETC.
...
## Credits
- Another thanks to [@cemtekinn](https://github.com/cemtekinn) for contributing the datatable adjustments, FormKit customizations and some example CRUDS integrations.